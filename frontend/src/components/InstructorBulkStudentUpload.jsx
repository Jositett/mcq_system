...
export default function InstructorBulkStudentUpload({ token, instructorId }) {
  ...
  const handleUpload = async () => {
    ...
    setError('');
    try {
      await axios.post(`${API_URL}/instructors/${instructorId}/batches/students/bulk`, preview, {
  ...
  return (
    <Box sx={{ mt: 2, maxWidth: 600 }}>
      <Paper sx={{ p: 3, mb: 2 }}>
        <Typography variant="h6" mb={1}>Bulk Add Students to My Batches</Typography>

...
export default function InstructorBulkStudentUpload() {
  ...
  const handleUpload = async () => {
    ...
    setError('');
    try {
      await api.post(`/instructors/${user.id}/batches/students/bulk`, preview);
  ...
  return (
    <div className="mt-4 w-full max-w-3xl">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-4 transition-colors duration-200">
        ...
        <h2 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Bulk Add Students to My Batches</h2>
